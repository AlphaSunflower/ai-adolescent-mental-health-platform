<template>
  <div class="field-admin-page">
    <div class="page-header">
      <h2>咨询领域管理</h2>
      <el-button type="primary" @click="openDialog('add')">
        <el-icon><Plus /></el-icon> 新增领域
      </el-button>
    </div>

    <el-table :data="fieldList" v-loading="loading" stripe>
      <el-table-column prop="id" label="ID" width="80"></el-table-column>
      <el-table-column prop="name" label="领域名称" min-width="150"></el-table-column>
      <el-table-column prop="code" label="领域代码" width="150"></el-table-column>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogType === 'add' ? '新增领域' : '编辑领域'" width="500px">
      <el-form :model="form" label-width="100px">
        <el-form-item label="领域名称" required>
          <el-input v-model="form.name" placeholder="请输入领域名称" />
        </el-form-item>
        <el-form-item label="领域代码" required>
          <el-input v-model="form.code" placeholder="请输入领域代码" />
        </el-form-item>
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="saveField" :loading="loading">确定</el-button>
      </template>
    </el-dialog>
  </div>
</template>
