...
create index idx_doctor_id
    on consultation_feedback (doctor_id);

create index idx_hospital_id
    on consultation_feedback (hospital_id);

create index idx_user_id
    on consultation_feedback (user_id);
...
create table if not exists course_source
(
    id               bigint auto_increment
        primary key,
...
create table if not exists inspirational_quote
(
    id          bigint auto_increment
        primary key,
